...
export default function EvolutionClassic4PlusPage() {
  return (
    <VehicleDetailPage
      ...
      description="Traditional 4-passenger golf cart with classic design and reliable performance. The EVOLUTION CLASSIC 4 PLUS offers timeless styling with modern electric efficiency for Eastern Seaboard coastal communities and golf enthusiasts."
