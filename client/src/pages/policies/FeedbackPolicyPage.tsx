      ...
      <section className="relative py-20 px-4 bg-gradient-to-r from-theme-primary to-blue-700 text-white bg-cover bg-center bg-no-repeat" style={getHeroBackgroundStyle("policy-feedback")}>
        <div className="max-w-7xl mx-auto text-center">
          ...
          <p className="text-xl mb-8 max-w-3xl mx-auto">
            Your feedback drives our continuous improvement and helps us provide exceptional service throughout Eastern Seaboard coastal communities.
          </p>
        </div>
      </section>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-white rounded-lg shadow-lg p-8">
            ...
            <div className="prose max-w-none">
              ...
              <p className="mb-6">
                At Bay Golf Carts, we value every customer's voice. Your feedback drives our 
                continuous improvement efforts and helps us provide exceptional service throughout 
                Eastern Seaboard coastal communities. This policy outlines how we collect, process, and act on customer feedback.
              </p>
